...
> **Compatibility**: This module is unchanged from the original Hypatia. All existing scripts, APIs, and tests remain fully functional. The generated network state is consumed by both the original ns-3 simulator and the new realtime visualization pipeline.
